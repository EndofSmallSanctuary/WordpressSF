...
//         length: 0
//     };
//     placemarkCollection = new ymaps.Clusterer({
...
//                             iconCaption: devsAndEvents[i].BleDev_Name +  moment.unix(devsAndEvents[i].BleEvt_Time/1000)
//                             .format("DD.MM.YYYY HH:mm:SS.ms")+ '\n' + '№'+ devsAndEvents[i].BleEvt_NumMsg,
//                         }, {
...
//                                 iconCaption: devsAndEvents[i].BleDev_Name +  moment.unix(devsAndEvents[i].GpsEvt_Time/1000)
//                                 .format("DD.MM.YYYY HH:mm:SS.ms")
//                             }, {
